                    ...
                    <section class="col-lg-10 col-md-10 col-sm-10 m_bottom_70 m_xs_bottom_30" style="width:80%;    margin-top: -25px;">
                        ...
                        if (1) {
                            ...
                            <div class="page_container" style='display: none'>
                                <div class='' ng-repeat="product in productList"></div>
                            </div>

                            <div ng-if="productList.length > 0" class="page shop_isotope_container1 t_xs_align_c three_columns m_bottom_15" data-isotope-options='{"itemSelector" : ".shop_isotope_item","layoutMode" : "fitRows","transitionDuration":"0.7s"}'>
