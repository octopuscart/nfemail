...
### card detail
    ...
    $countproduct = $cartprd->cartProductsCount($_SESSION['user_id'], 'and customization_id != 0');
...
#update14-dec-2015
    if (isset($_POST['shipping_id'])) {
        ...
        $order_id = $cartprd->insertInOrderTable($qun, $pri, $cartIdss, $user_id, $billId, $shipId, $coupon_id, $card_id, $skus, $imagess, $prices, $tag_titles, $wallet);
            ...
            <ul class="nav nav-tabs" role="tablist" style="font-size: 20px">
                ...
                <li role="presentation" class="">
                    <a href="#billingShipping" aria-controls="billingShipping" role="tab" data-toggle="tab">
                        <span class="circle icon_wrap_size_1 d_inline_m m_right_8"><i class="icon-map"></i></span>Shipping/Billing Address
                    </a>
                </li>
            ...
            <!--                                            <p class="fw_light d_inline_m m_right_5 d_xs_block"></p>-->
                ...
                <div role="tabpanel" class="tab-pane" id="billingShipping">
                    ...
                    <?php if ($addressData) { ?> 
                        <div class="col-md-12" style="margin-top: 10px;">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Choose Address for Shipping and Billing
                    ...
                    <?php } else { ?>
                        ...
                        <p style="text-align: center;color:red;margin-top: 24px;font-size:18px;font-weight:400">SHIPPING & BILLING ADDRESS NOT FOUND! PLEASE ADD YOUR  SHIPPING & BILLING ADDRESS</p>
                        <center>
                    ...
                    <div class="" style="margin-top: 10px;">
                        <div class="col-lg-6 col-md-6 col-sm-6 m_bottom_40 m_xs_bottom_30">
                            <p class="" style="font-size: 28px;font-weight: 300;
                               ...
                               color: #fff;
                               margin-bottom: 20px;
                               "><i class="icon-truck"></i> Delivery Method</p>
                            ...
                            <ul>
                                <li class="m_bottom_15">
                                    ...
                                    <label for="radio_4" class="d_inline_m m_right_15 m_bottom_3 fw_light">Delivery Method 1 <span class="color_grey"></span></label>
                                </li>
                                <li>
                                    <input type="radio" id="radio_5" name="method_1" class="d_none">
                                    <label for="radio_5" class="d_inline_m m_right_15 m_bottom_3 fw_light">Delivery Method 2 <span class="color_grey"></span></label>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 m_bottom_40 m_xs_bottom_30">
                ...
                <div role="tabpanel" class="tab-pane" id="confirmOrder">
                    <div class="col-md-12" style="margin-top: 10px;">
                        ...
                        <!--<form method="post">-->   
                        <input type="hidden" name="allCartId" value="<?php echo implode(",", $cartIdArray); ?>">
                        <input type="hidden" name="totalQuantity" value="<?php echo $countproduct[0]['quantity']; ?>" >
                        <input type="hidden" name="totalPrice" value="">
                        <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                        <input type="hidden" name="coupon_id" value="<?php echo $cp['coupon_id']; ?>">
                        <input type="hidden" name="sku" value="<?php echo implode(",", $item_sku); ?>">
                        <input type="hidden" name="images" value="<?php echo implode(",", $img_arry); ?>" >
                        <input type="hidden" name="price" value="<?php echo implode(",", $item_price); ?>"">
                        <input type="hidden" name="tag_titles" value="<?php echo implode(",", $item_title); ?>">
                        <input type="hidden" name="wallet_amount" value="<?php echo $use_wallet; ?>" >
                ...
                <!--                         <a href="shippingCart.php" class="d_inline_b tr_all r_corners button_type_1 color_pink fs_medium mini_side_offset"><i class="icon-check d_inline_b m_right_5"></i> Checkout Now</a>-->
                                    <button type="submit" name="orderConfirm" id="btn1" class="d_inline_b tr_all r_corners button_type_1 color_pink fs_medium mini_side_offset" value="dfjdg" style="margin: 0px 0px 10px 0px;display: none">
                                ...
                                ?>
                                <div style="text-align:center;margin-bottom: 40px;">
                                    <p style="text-align: center;color:red;margin-top: 24px;font-size:18px;font-weight:400">PLEASE ACTIVATE BOTH (SHIPPING AND BILLING) ADDRESS</p>
                                </div>
                                <?php
                            }
                        }
