                                ...
                                <div class='col-md-12' style="" align="center">
                                    ...
                                    <table class="profile" align="center" style="color:black">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="gender" class="form-control"  style="height: 30px;"  disabled>
                                                    <option value="Male" <?php if ($userInfo[0]['birth_date'] == 'Male') { ?> Selected =' selected' <?php } ?> >Male</option>
                                                    <option value="Female" <?php if ($userInfo[0]['birth_date'] == 'Female') { ?> Selected =' selected' <?php } ?> >Female</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="email" class="form-control" value="<?php echo $userInfo[0]['email']; ?>" style="height: 30px;"   disabled>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" name="" class="btn btn-default btn-xs edit" style="">
                                                    <i class="icon-edit"></i> Edit 
                                                </button>


                                                <button type="submit" name="updateData" class="btn btn-default btn-xs submit" style="display: none">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <table class="profile" align="center" style="color:black">
                        <tr>
                            <td>
                                <span for="name" class="control-label"><b>Old Password</b></span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span for="name" class="control-label"><b>New Password</b></span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span for="name" class="control-label"><b> Confirm Password</b></span>
                            </td>
                            <td>
