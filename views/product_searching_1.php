    ...
    <div class="section_offset" style="padding: 13px 0 67px;">
        <div class="container" >
            <div class="row">
                ...
                <aside class="col-lg-2 col-md-2 col-sm-2 m_bottom_70 m_xs_bottom_30" style="width:18%">
                        ...
                        <form id="filterform">
                            ...
                            <div class="m_bottom_20" style="margin-top:-8%">
                                ...
                                for ($i = 0; $i < count($productList); $i++) {
                                    ...
                                    array_push($pricelist, $productList[$i]['price']);
                                }
                                $color_list4 = implode(",", $productIDS);
                                if ($color_list4) {
                                    $query = "
                                        SELECT nc.id,nc.color_code FROM nfw_color as nc
   join nfw_product_color as npc on npc.nfw_color_id = nc.id

   where npc.nfw_product_id in ($color_list4)
   group by nc.id
                                            ";
                                    //  echo $query;
                                    ...
                                    <ul class="hr_list color_list">
                                        ...
                                        foreach ($colorArray as $key => $value) {
                                            ...
                                            <li class=" m_sm_bottom_5">
                                                ...
                                                <input type="checkbox" id="shop_style<?php echo $value['id']; ?>"" class="shop_style d_none selected_colors" name="colors" value="<?php echo $value['id']; ?>">
                                                <label for="shop_style<?php echo $value['id']; ?>"" class="d_inline_m m_right_10 color_button color_button_check tr_delay  bg_color_dark " style="font-size: 22px;background:<?php echo $value['color_code']; ?>;"></label>
                                ...
                                <div class="custom_select products_filter type_2 f_xs_none m_xs_left_0 f_left m_xs_bottom_10" style="margin:1px 30px 10px 0px;">
                                    ...
                                    <select class="target d_none" name="Fabric_Category">
                                        <?php
                                        $query = "select id, title from nfw_fabric";
    ...
    <!--                                <button type="reset" id="reset_filter_form" form="manufacturers_form" class="btn btn-default btn-xs" onclick=" window.location.href = 'http://192.168.3.47/nf3/frontend/views/product_list.php?category=0&item_type=1'"><i class="icon-arrow">Reset</button>-->
                ...
                if (count($productList)) {
                    ?>
                    <section class="col-lg-10 col-md-10 col-sm-10 m_bottom_70 m_xs_bottom_30" style="width:82%">
                        <!--filter-->
...
//print_r($pricelist);
    ...
    <script>
        $(function () {
            $("select[name='Fabric_Category']").val("<?php echo isset($_REQUEST['Fabric_Category']) ? $_REQUEST['Fabric_Category'] : 'Fabric Category'; ?>");
            $('.rc_first_hr').attr('id', 'page_' +<?php echo $_REQUEST['page_no'] - 1; ?>);
            $('.rc_last_hr').attr('id', 'page_' +<?php echo $_REQUEST['page_no'] + 1; ?>);
