    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 m_bottom_70 m_xs_bottom_30" style="margin-bottom:0px">
                <div class="panel panel-default" style="width:80%;margin-left: 13%;margin-top: -45px;">
...
<!--                                        <td><?php echo $productInfo['tag_name']; ?></td>-->
          ...
          <span style="font-size:20px;margin-left:13%">To Customize, Please Login.</span><br/>
        <span style="font-size:20px;margin-left:13%;float: left;margin-top: 10px">New to Nita Fashions? Click to Create an Account &#x2192; </span><a href="./registration.php" style="margin-top:6px" class="btn btn-default">Register Now</a>
        <!--banners-->
    </div>
</div>
<?php }else {?>
