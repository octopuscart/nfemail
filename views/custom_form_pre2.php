                    ...
                    <div class="col-md-12 style_creation animated" style="padding: 0px">
                        ...
                        <div class="col-md-5">
                            <p
                                ...
                                margin-bottom: 6px;"
                                >
                                Create New Customize Style?
                                <span id="create_new_style"
                                      style="color: #f00;
                                      font-weight: 400;
                                      cursor: pointer;
                                      "
                        ...
                        <!--                        <div class="col-md-6">
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body" style="">
                                                            <div class="measurment_summery final_summery" style="border: 1px solid #000;
                                                                 padding: 5px;"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body" style="">
                                                            <table class="table-responsive" style="width: 100%">
                                                                <tr class="mes_th">
                                                                    <th>Profile Name</th>
                                                                    <td mes_parent="profile_name"></td>
                                                                </tr>
                                                                <tr class="mes_th">
                                                                    <th>Height</th>
                                                                    <td mes_parent="height"></td>
                                                                </tr>
                                                                <tr class="mes_th">
                                                                    <th>Weight</th>
                                                                    <td mes_parent="weight"></td>
                                                                </tr>
                                                                <tr class="mes_th">
                                                                    <th>Age</th>
                                                                    <td mes_parent="age"></td>
                                                                </tr>
                        <?php
                        foreach ($measurmentArray as $key => $value) {
                            ?>
                                                                                
                                                                                                                            <tr class="mes_th">
                                                                                                                                <th><?php echo $value; ?></th>
                                                                                                                                <td mes_parent="<?php echo $key; ?>"></td>
                                                                                                                            </tr>
                            <?php
                        }
                        ?>
