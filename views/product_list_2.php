                            ...
                            <div class="" >
                                <div  class="page_container shop_isotope_container1 t_xs_align_c three_columns m_bottom_15" data-isotope-options='{"itemSelector" : ".shop_isotope_item","layoutMode" : "fitRows","transitionDuration":"0.7s"}'>
                                    ...
                                    for ($i = 0; $i < count($productList); $i++) {
                                        ...
                                        <div class="page shop_isotope_item d_xs_inline_b animated appear-animation bounceIn appear-animation-visible" data-appear-animation="bounceIn" style="width: 25%; float: left;"  >
                                            <figure class="fp_item t_align_c d_xs_inline_b ">
                                                <div class="relative r_corners d_xs_inline_b d_mxs_block wrapper m_bottom_23 t_xs_align_c">
                                                    <!--images container-->
                                                    <a href="shop_product.php?product_id=<?php echo $product['id']; ?>&item_type=<?php echo $item_type; ?>" class='redirecturl'>
                                                        <div class="fp_images relative ">
                                                            <img src="<?php echo $product['image1']; ?>" alt="" class=" tr_all img1 lazy" data-original="<?php echo $product['image1']; ?>" style="height:250px; width:250px;background: url(<?php echo $defaultProduct; ?>)" >
                                                            <img src="<?php echo $product['image2']; ?>"  alt="" class=" tr_all img2 lazy" data-original="<?php echo $product['image2']; ?>" style="height:250px; width:250px;display: none;background: url(<?php echo $defaultProduct; ?>);" >
                                                        </div>
                                                        <div class="fabric_color" style="">

                                                            <center class="fabric_color_list">
                                                                <button ng-repeat="color in <?php echo json_encode(explode(',', $product.color)); ?>" 
                                                ...
                                                <figcaption>
                                                    ...
                                                    <a href="#" class="fs_medium color_grey d_inline_b m_bottom_3"> 
                                                        <i class="product_speciality" data-toggle="tooltip" data-placement="center" title="<?php echo $product['product_speciality']; ?> ">
