                ...
                data: requestobj, success: function (data) {
                    ...
                    for (pt in data) {
                        ...
                        if (product['sale_price'] > 0) {
                            ...
                            $(obj).find(".price_pd").html("<span class='cut_price'>US$ " + product['price'] + "</span><span class='sale_price'>US$ " + product['sale_price'] +"</span><br/><span class=''>" + product['tag_title'] + "</span>");
                            $(obj).find(".product_sort_type").show().find("span").html('Sale');

                        }
                        else {
                            $(obj).find(".price_pd").html("<span class=''>US$ " + product['price'] +"</span><br/><span class=''>" + product['tag_title'] + "</span>"  );
                        }
