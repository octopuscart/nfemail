                                ...
                                <form class="form-horizontal" role="form" method="post">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-3" style="width:191px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control is_number" name="cvv" id="cvv" placeholder="Code"  min="3" max="3" style="width:25%" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                <button type="submit" class="btn btn-default btn-xs" name="card_submit">
            ...
            <form method="post">
                <div class="modal-body">
                    <table class="updateAddress">
                        ...
                        <tr>
                            <td>
                                <span for="name"><b>Bank Name</b></span>
                            </td>
                            <td>
