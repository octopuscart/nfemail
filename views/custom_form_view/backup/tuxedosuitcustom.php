...
$number_of_back_pocket = array(
    'a_2_pockets_with_buttons' => '1 Pocket - Right Side',
    'left_pocket' => '1 Pocket - Left Side',
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="padding: 15px 15px 0px 15px; ">
                            ...
                            <p style="    margin: -8px 0px 11px;">
                                <b class="selected" parent_style="Button" child_style="Standard">Fully Lined</b> is standard <b>Lining Styles</b>
...
<script>
    ...
    function customDefaultSet(prd_id) {
        ...
        productStyleArray[prd_id]['Lining Styles'] = 'Fully Lined';
