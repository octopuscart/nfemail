    ...
    <div class="col-md-12 measurement_selection_block animated" style="padding: 0px">
        <div class="col-md-7">
            <p
                ...
                margin-bottom: 6px;"
                >
                <input type="radio" id="new_measurement_profile" name="mes_radio" class="d_none new_measurement_profile" value="" checked="true">
                <label for="new_measurement_profile" class="d_inline_m m_right_10" style="">

                    Create New Measurement Profile? </label> 
                <label style="padding-top: 3px;"> <span id="create_new_measurement"
                                                        style="color: #f00;
                                                        font-weight: 400;
                                                        margin-left: -8px;
                                                        cursor: pointer;
                                                        "
                                                        >Click Here</span></label></p>
            <small style="margin-left: 58px;">Or</small>
            <p
                style="font-size: 22px;
                margin-top: 3px;
                font-weight: 300;
                ...
                margin-bottom: 6px;"
                >
                Choose From Below Preferred Measurement Profiles.
            </p>
            ...
            if (count($pre_measurement)) {
                ...
                <div class="accordion">
                    ...
                    foreach ($pre_measurement as $key => $value) {
                        ?>
                        <dl class="custom_measurement accordion_item r_corners wrapper m_bottom_5 tr_all <?php echo $count == 0 ? 'active' : ''; ?>">
                                ...
                                <div class='col-md-12' style="padding: 0px;">
                                    <table class='table-bordered pre_profiles' style="width: 100%;margin-bottom: 10px">
                                        ...
                                        foreach ($image_data as $key1 => $value1) {
                                            ...
                                            echo "<img class='userimageclass' src='http://nf1.costcokart.com/nfw/small/", trim($value1, '"'), "' >";
                                        }
                                        echo "</td></tr>";
                                        ?>
                            ...
                            <div class="panel-body" style="  padding: 15px 15px 0px 15px; ">
                                <div class="row" >
                                    ...
                                    <div class='col-md-12' style="background: #fff;padding-bottom: 15px;">
                                        <?php
                                        for ($i = 0; $i < count($measurment_text[$key]); $i++) {
                                            $point = $measurment_text[$key][$i];
...
<script>
    ...
    function setPosture() {
        ...
        for (i in posture_array) {
            var pt = i;
            console.log(i, "f sadfsad fsdafsadf sadf sdf");
    ...
    var imageUploadCdn = "http://costcointernational.com/imageUploadFunction.php";
    var imagePrePath = "http://costcointernational.com/nfw/small/"
