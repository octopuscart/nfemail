...
//        end of offer coupon
        ...
        if ($card_id == 'paypal') {
           ...
           echo  $order_id = $cartprd->insertInOrderTable($qun, $cartIdss, $user_id, $billId, $shipId, $coupon_id, $card_id, $skus, $imagess, $prices, $tag_titles, $wallet, $ship_amt, $subtotal);
