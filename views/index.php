    ...
    <div class="container frontpagecontainer" style="margin-top: -50px;">
        ...
        <div class="relative m_bottom_70 m_xs_bottom_30" style="margin-bottom: 50px;">
            ...
            <div class="row">
                ...
                <div class="owl-carousel t_xs_align_c featured_products" data-nav="fproducts_nav_" data-plugin-options='{"singleItem":false,"itemsCustom":[[992,5],[768,3],[600,2],[10,1]]}'>
                    <?php
                    ...
                    for ($i = 0; $i < count($productList); $i++) {
                        ...
                        for ($k = 0; $k < count($result); $k++) {
                            ...
                            ?>
                            <!--product-->
                            <figure class="fp_item t_align_c d_xs_inline_b col-lg-12 col-md-12 col-sm-12 animated" data-appear-animation="bounceIn" style="    width: 240px;">
                                <a href="shop_product.php?product_id=<?php echo $result[$k]['product_id']; ?>&item_type=<?php echo $result[$k]['tag_id'] ?>">
                                    <div class="relative r_corners d_xs_inline_b d_mxs_block wrapper m_bottom_23 t_xs_align_c animated">
                                        <!--images container-->

                                        <div class="fp_images relative">
                                            <img src="<?php echo $productDualImage[0]['image']; ?>" alt="" class="tr_all" style ="height:250px; width: 250px">
                                            <img src="<?php echo $productDualImage[1]['image']; ?>" alt="" class="tr_all"style ="height:250px; width: 250px">
        ...
        <!--                                    <input type="text" name="item_type" value="<?php echo $result[$k]['tag_id'] ?>" >-->
                                    ...
                                    <a href="shop_product.php?product_id=<?php echo $result[$k]['product_id']; ?>" class="fs_medium color_grey d_inline_b m_bottom_3" title="<?php echo $productInfo['product_speciality']; ?>">
                                        <i><?php
                                    ...
                                    <div class="im_half_container m_bottom_10">
                                        <p class="color_dark  half_column d_inline_m t_align_c tr_all animate_fctl fp_price with_ie"><?php echo $result[$k]['tag_title']; ?> - <?php echo '$' . $result[$k]['price']; ?></p>	
